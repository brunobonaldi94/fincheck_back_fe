	...
	return (
		<div className="relative">
			<input
				...
				name={name}
				placeholder=" "
				className={cn("bg-white rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800 w-full pt-4 peer placeholder-shown:pt-0 focus:border-gray-800 transition-all outline-none",
